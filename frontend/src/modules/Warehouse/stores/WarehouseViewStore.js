...
class WarehouseViewStore {
    ...
    //TESTNI PODATCI
    allData = [
        { id: 1, name: "MARTINA DIVALTA 120", location_id: 1, location_name: "Lokacija11", users: [{ name: 'KORISNIK 1', id: 1 }, { name: 'KORISNIK 2️', id: 2 }] },
        { id: 2, name: "Testna ulica 11", location_id: 2, location_name: "Lokacija12", users: [{ name: 'KORISNIK 1', id: 1 }, { name: 'KORISNIK 2️', id: 2 }] },
        { id: 3, name: "Sokovi", location_id: 3, location_name: "Lokacija13", users: [{ name: 'KORISNIK 1', id: 1 }, { name: 'KORISNIK 2️', id: 2 }] },
        { id: 4, name: "Cigarete", location_id: 2, location_name: "Lokacija14", users: [{ name: 'KORISNIK 1', id: 1 }, { name: 'KORISNIK 2️', id: 2 }] },
        { id: 5, name: "Koverta", location_id: 3, location_name: "Lokacija15", users: [{ name: 'KORISNIK 1', id: 1 }, { name: 'KORISNIK 2️', id: 2 }] },
        { id: 6, name: "Tst2", location_id: 1, location_name: "Lokacija16", users: [{ name: 'KORISNIK 1', id: 1 }, { name: 'KORISNIK 2️', id: 2 }] },
        { id: 7, name: "Test3", location_id: 4, location_name: "Lokacija17", users: [{ name: 'KORISNIK 1', id: 1 }, { name: 'KORISNIK 2️', id: 2 }] },
        { id: 8, name: "Test4", location_id: 4, location_name: "Lokacija19", users: [{ name: 'KORISNIK 1', id: 1 }, { name: 'KORISNIK 2️', id: 2 }] },
        { id: 9, name: "Tst5", location_id: 2, location_name: "Lokacija112", users: [{ name: 'KORISNIK 1', id: 1 }, { name: 'KORISNIK 2️', id: 2 }] },
        { id: 10, name: "Test6", location_id: 2, location_name: "Lokacija1124", users: [{ name: 'KORISNIK 1', id: 1 }, { name: 'KORISNIK 2️', id: 2 }] }
    ];
