            ...
            <div className="filterCard" style={{ marginBottom: 10 }}>
                <div className="row">
                    ...
                    <div className='col-md-4 filterColumn'>
                        <DropdownButton style={{ margin: "auto" }} className="vertical-center" variant="light" title={categoryFilter.name ? categoryFilter.name : "Sve kategorije"} style={{ marginBottom: 10 }}>
